...
class ValueFailureRecorder {
	...
	constructor(
		...
		private manager: Manager<ValueFailure, IValueFailureObject, List<ValueFailure>>
			= new Manager<ValueFailure, IValueFailureObject, List<ValueFailure>>(ValueFailure, List, connection)
	) {}
